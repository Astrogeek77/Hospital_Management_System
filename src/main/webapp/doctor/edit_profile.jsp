...
<title>HMS | Doctor | Edit Profile</title>
<style type="text/css">
.paint-card {
				...
				<div class="card paint-card">
					...
					<div class="card-body">
						<form action="../doctChangePassword" method="post">
							<div class="mb-3">
								<label>Enter Current Password</label> <input type="text"
						...
						<form action="../doctorUpdateProfile" method="post">
							...
							<div class="mb-3">
								<label class="form-label">Specialist</label> <select name="spec"
									...
									<option>${doctObj.specialisation }</option>

									<%
									SpecialistDAO dao = new SpecialistDAO(connectDB.getConn());
